package ThothGUI.thoth_lite.components.db_elements_view.identifiable_card;
...
public abstract class IdentifiableCard
    ...
    private Button getButton(
        ...
        Button res = ThothGUI.thoth_lite.components.controls.Button.getInstance(text.text, event);
        res.setId(text.text);
        return res;
    }
